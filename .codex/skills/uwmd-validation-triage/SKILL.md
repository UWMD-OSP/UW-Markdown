---
name: uwmd-validation-triage
description: Use when reviewing UWMD validation results and proposing remediation. Map validation issues to bounded, evidence-backed edits; never fabricate facts to clear a warning.
---

# UWMD Validation Triage

## Contract

Map validation issues to bounded, evidence-backed edits; never fabricate facts to clear a warning.
