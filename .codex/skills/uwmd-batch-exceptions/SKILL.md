---
name: uwmd-batch-exceptions
description: Use when triaging invalid or warning-bearing entries from a UWMD collection index. Group exception records and emit per-deal candidate edits or escalation records.
---

# UWMD Batch Exception Triage

## Contract

Group exception records and emit per-deal candidate edits or escalation records.
