...
| 2 | CAM, redevelopment and OpEx compression | **RFC 0058 drafted for the CAM half** — recovery terms typed on the tenant record (share, stop, pool, cap accumulation) plus an annual stated-and-verified true-up over a closed period, using §4.26 as the dated sink. Unblocked by the RFC 0054 decision: a reconciliation of a past year is not a periodic ledger. Expense-targeted capex shipped in RFC 0057. Redevelopment/downtime is still an open scoping question against §4.25 + §4.8. |
