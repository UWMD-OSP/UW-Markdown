...
|---|---|---|---|
| 1 | Real-deal DCF validation and extensions | Completed monthly evidence assessed; current-contract blockers identified | The [completed-corpus review](docs/reviews/2026-09-24-completed-golden-corpus-validation.md) replaces the all-annual blocker: monthly projections and dated metrics pass, while unchanged assembly refuses final-period timing and reserve-funded spending. Resolve the same-day `PS-02` validation interaction through a narrow RFC and refresh stale private crosswalks. Terminal-boundary, levered/tax and reserve-rollforward work remain separate contracts. |
