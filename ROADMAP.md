...
|---|---|---|---|
| 1 | Real-deal DCF validation and extensions | Completed monthly evidence assessed; current-contract blockers identified | The [completed-corpus review](docs/reviews/2026-09-24-completed-golden-corpus-validation.md) replaces the all-annual blocker: monthly projections and dated metrics pass, while unchanged assembly refuses final-period timing and reserve-funded spending. The [RFC 0062 draft](docs/rfcs/0062-same-day-cash-flow-selection.md) prepares the same-day reconciliation as owner-selected Protocol 2.17.1 errata; RFC acceptance and stale private crosswalk refresh remain pending. Terminal-boundary, levered/tax and reserve-rollforward work remain separate contracts. |
