...
```json uw:section=risk_assessment superseded=true source=user ts=2026-04-24T14:00:00Z v=1 confidence=low
{
  "_meta": {
...
```json uw:section=risk_assessment source=L6 ts=2026-04-25T17:56:42.213Z v=2 confidence=medium
{
  "_meta": {
    "section": "risk_assessment",
    "version": 2,
...
```json uw:section=pipeline_log source=system ts=2026-04-25T17:56:42.213Z v=2
{
  "_meta": {
