...
Loan sizing against the three standard constraints. The governing test is dscr; the proposed loan of $16,240,000 fits inside it.
...
```json uw:section=preliminary_sizing source=manual ts=2026-08-26T09:00:00Z v=1 confidence=medium
{
  ...
  "max_supportable_loan": 18948151,
  "governing_constraint": "dscr",
  "proposed_loan": 16240000,
...
Ironwood Logistics Holdings LLC — single-principal sponsorship; figures PFS-stated pending CPA verification.
...
```json uw:section=borrower_sponsor source=manual ts=2026-08-26T09:00:00Z v=1 confidence=medium
{
  ...
  "principals": [
    {
      ...
      "is_guarantor": true,
      "is_key_man": true,
      "net_worth_stated": 29232000,
      "liquid_assets_stated": 1786400,
  ...
  "entity": {
    "name": "Ironwood Logistics Holdings LLC",
    "type": "llc",
    "state": "AZ"
  },
  "financial_summary": {
    "global_net_worth": 29232000,
    "global_liquidity": 1786400,
...
Tolleson / Southwest Valley infill logistics fundamentals as of 2026-08.
...
```json uw:section=market_analysis source=manual ts=2026-08-26T09:00:00Z v=1 confidence=medium
{
  ...
  "submarket": "Tolleson / Southwest Valley",
  ...
  "rents": {
    "yoy_growth_pct": 0.035,
    "trend": "moderate"
  },
  "cap_rates": {
    "range_low": 0.06,
    "range_high": 0.065,
    "subject_going_in": 0.0625
  },
  "supply": {
    "note": "Big-box deliveries elevated along Loop 303; sub-200k SF infill product remains supply-constrained."
  }
}
```
  ...
  "financial_validity": [
    {
      ...
      "severity": "pass",
      "message": "DSCR (1.4584x) clears the 1.20x warning threshold.",
      "suppressed": false,
    ...
    },
    {
      ...
      "severity": "pass",
      "message": "LTV at 58.0% is within the 75% policy maximum.",
      "suppressed": false,
      "suppress_reason": null
    }
  ],
