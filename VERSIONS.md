...
| `@uwmd/core` | **2.6.1** | format 2.0 (reads 1.x), protocol 2.6.0 |
| `@uwmd/cli` (CLI) | **2.6.1** | `@uwmd/core` 2.6.1 |
| `@uwmd/excel` | **0.8.9** | `@uwmd/core` 2.6.x, format 1.1 multifamily pack |
| `@uwmd/report` | **0.8.9** | `@uwmd/core` 2.6.x, format spec §7.1/§7.2 |
| `@uwmd/batch` | **0.8.4** | `@uwmd/core` 2.6.x, `.uwx.md` collections + corpus fact table (first published at 0.8.0, 2026-09-03) |
| `@uwmd/signing` | **0.2.9** | `@uwmd/core` 2.6.x, protocol §V.11 + §XIV capability tokens (0.1.0 published 2026-09-01 pairs core 1.8.x) |
