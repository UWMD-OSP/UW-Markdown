...
| `@uwmd/batch` | **0.7.3** | `@uwmd/core` 2.1.x, `.uwx.md` collections |
| `@uwmd/signing` | **0.2.3** | `@uwmd/core` 2.1.x, protocol §V.11 + §XIV capability tokens (0.1.0 published 2026-09-01 pairs core 1.8.x) |
| `@uwmd/module-hospitality` | **0.1.0** (unpublished) | `@uwmd/core` 2.1.x, protocol §X module system |
| `tools/web-editor` | **0.8.0** (private) | `@uwmd/core` 2.1.x browser entry |
