...
2.10.0 (RFCs 0042/0043); the published core/CLI 2.7.0 artifacts still implement 2.8.0.
...
| UW Protocol | **2.10.0** | format ≥ 1.0 (contextual Excel period bindings, RFC 0043; package release pending) |
