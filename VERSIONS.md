...
| `@uwmd/core` | **1.2.0** | format 1.1, protocol 1.3.0 (published); the working tree implements 1.4.0 and needs a release cut |
...
| `@uwmd/batch` | **0.1.0** | `@uwmd/core` 1.2.x, `.uwx.md` collections |
| `tools/web-editor` | **0.5.0** (private) | `@uwmd/core` 1.2.x browser entry |
