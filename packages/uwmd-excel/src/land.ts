...
const namedInputs: readonly NamedInput[] = [
  ...
  { name: 'gross_acres',             label: 'Gross Acres',             source: { section: 'property',       path: 'gross_acres' },             format: 'count' },
  { name: 'usable_acres',            label: 'Usable Acres',            source: { section: 'property',       path: 'usable_acres' },            format: 'count' },
  { name: 'entitled_units',          label: 'Entitled Units (Lots)',   source: { section: 'property',       path: 'entitled_units' },          format: 'count' },
