...
| [0041](./0041-period-indexed-addressing.md) | Period-indexed addressing — one period axis over the format's per-period series | draft | format, protocol, core, conformance |
