# Historical build-status notes through 2.7.0

Archived 2026-09-12. Entries below describe different points in the project's
history and can contradict one another. They are not an active backlog.
Use [the living status page](13-status.md) for current capabilities and gaps.
