...
Implementation committed as fc86ab9. Build, 1,852 workspace tests, test typechecking,
502 conformance cases, 28 schemas, lint, lockfile/package/version/index/release
guards and docs build passed. Native Excel 16.0 build 20326 passed 14 scenarios /
48 cell checks; seven worksheet views inspected after final formatting.

- [x] Implement, synchronize contracts, verify, and commit the bounded stage.

Package publication remains pending owner review; no release or merge performed.
